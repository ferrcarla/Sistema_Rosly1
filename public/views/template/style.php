<!-- Bootstrap CSS -->
<link rel="shortcut icon" type="image/x-icon" href="<?php echo ROOT; ?>img/logos.png">
<link rel="stylesheet" href="<?php echo ROOT; ?>resources/assets/css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo ROOT; ?>resources/assets/font/bootstrap-icons.css">
