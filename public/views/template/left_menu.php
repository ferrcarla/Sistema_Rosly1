<div id="sidebar-container" class="bg-primary">
    ...
    <div class="menu">
        ...
        <a href="#" class="d-block text-light p-3"><i class="icon ion-md-stats mr-2 tead"></i> Entradas</a>
        <a href="#" class="d-block text-light p-3"><i class="icon ion-md-person mr-2 tead"></i> Salidas</a>
